...
In caso non si possieda, si può consultare la guida online rilasciata ufficialmente dagli sviluppatori di Docker. https://docs.docker.com/engine/install/ubuntu/
Installato correttamente Docker, ora si può avviare il file docker.sh da terminale con il comando:
$  ./docker.sh
...
All'interno della cartella "Project" sono racchiusi altre cartelle come Edge, Client con i loro file .py e i dockerfile.
